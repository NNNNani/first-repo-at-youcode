 ...
 *
 * 🎯 MISSION
 * À partir d'un tweet : "Beau temps à #Nador aujourd'hui avec la team #YouCode !", extrayez tous les hashtags et 
 * retournez-les dans un tableau ["#Nador", "#YouCode"].
 *
...
function extraireHashtags(tweet) {
    let m = tweet.split(" ") ;

    let hashtags = m.filter(function(mot) {
