/**
 * ─────────────────────────────────────────────────────────────
 * JOUR 01 · EXERCICE 20 · NIVEAU 3 : DÉFI (AVANCÉS)
 * LE GRAND MÉNAGE (OPÉRATEURS DE COALESCENCE)
 * ─────────────────────────────────────────────────────────────
 *
 * 🎯 MISSION
 ...
 * ▶️ Commande : node day01/exercices/exercice-20.js
 */
'use strict';
...
const nom = null ;
const pseudo = "NinjaCoder" ;

const nomAAfficher = nom ?? pseudo ?? "Anonyme" ;
